      ...
      <div class="menu_section">  
        <ul class="nav side-menu">
          ...
          <?php if (hasAccess('admission/menu', $currentUser)): ?>
            <li class="nav-link-side nav-student-admission nav-student-application nav-transferee nav-cat nav-registered-students nav-scholarship-application nav-school nav-scholarship-name"><a><i class="ti ti-bookmark-alt"></i> Admissions </a>
              <ul class="nav child_menu collapse collapse-student-admission collapse-student-application collapse-transferee collapse-cat collapse-registered-students collapse-scholarship-application collapse-school collapse-scholarship-name">
          ...
          <?php if (hasAccess('registrar/menu', $currentUser)): ?>
            <li class="nav-link-side nav-completion nav-request-form nav-prospectus nav-tor nav-student-behavior nav-adding-dropping-subject nav-approval-of-enrolled-course nav-club nav-student-club"><a><i class="fa fa-briefcase"></i> Registrar </a>
              <ul class="nav child_menu collapse collapse-completion collapse-request-form collapse-prospectus collapse-tor collapse-adding-dropping-subject collapse-club collapse-student-behavior collapse-approval-of-enrolled-course collapse-student-club">
                ...
                <?php if (hasAccess('prospectus/index', $currentUser)): ?>
                  <li class="nav-link-side nav-prospectus">
                    <a href="#/registrar/prospectus" onclick="change('prospectus')">Prospectus</a>
                  </li>
                <?php endif ?>
          ...
          <?php if (hasAccess('cashier/menu', $currentUser)): ?>
            <li class="nav-link-side nav-payment"><a><i class="fa fa-credit-card"></i> Cashier </a>
              <ul class="nav child_menu collapse collapse-payment">
          ...
          <?php if (hasAccess('guidance and counseling/menu', $currentUser)): ?>
            <li class="nav-link-side nav-referral-slip nav-counseling-appointment nav-attendance-counseling nav-counseling-type nav-counseling-intake nav-promissory-note nav-good-moral nav-affidavit nav-gco-evaluation nav-calendar-activities nav-customer-satisfaction nav-participant-evaluation nav-student-exit"><a><i class="fa fa-users"></i> Guidance & Counseling </a>
              <ul class="nav child_menu collapse collapse-referral-slip collapse-counseling-appointment collapse-attendance-counseling collapse-counseling-type collapse-counseling-intake collapse-promissory-note collapse-good-moral collapse-affidavit collapse-gco-evaluation collapse-calendar-activities collapse-customer-satisfaction collapse-participant-evaluation collapse-student-exit">
          ...
          <?php if (hasAccess('faculty/menu', $currentUser)): ?>
            <li class="nav-link-side nav-faculty-clearance nav-student-clearance nav-faculty-management nav-grades nav-program-advisers nav-student-attendance"><a><i class="fa fa-user"></i> Faculty </a>
              <ul class="nav child_menu collapse collapse-faculty-clearance collapse-student-clearance collapse-faculty-management collapse-grades collapse-program-advisers collapse-student-attendance">
          ...
          <?php if (hasAccess('health and medical service/menu', $currentUser)): ?>
            <li class="nav-link-side nav-student-log nav-prescription nav-medical-certificate nav-referral-recommendation nav-dental nav-property-log nav-medical-consent nav-illness-recommendation nav-consultation nav-invnetory-log nav-medical-student-profile nav-medical-employee-profile nav-nurse-profile nav-item-issuance"><a><i class="fa fa-medkit"></i> Health & Medical Services </a>
              <ul class="nav child_menu collapse collapse-student-log collapse-prescription collapse-medical-certificate collapse-referral-recommendation collapse-dental collapse-property-log collapse-medical-consent collapse-illness-recommendation collapse-consultation collapse-invnetory-log collapse-medical-student-profile collapse-medical-employee-profile collapse-nurse-profile collapse-item-issuance">
          ...
          <?php if (hasAccess('learning resource center/menu', $currentUser)): ?>
            <li class="nav-link-side nav-learning-resource-member nav-bibliography nav-material-type nav-collection-type nav-member nav-check-out nav-check-in nav-inventory-bibliography nav-visitors"><a><i class="ti ti-book"></i> Learning Resource Center </a>
              <ul class="nav child_menu collapse collapse-learning-resource-member collapse-bibliography collapse-material-type collection-material-type collapse-member collapse-check-out collapse-check-in collapse-inventory-bibliography collapse-visitors">
          ...
          <?php if (hasAccess('corporate affairs/menu', $currentUser)): ?>
            <li class="nav-link-side nav-apartelle nav-apartelle-registration nav-student-list"><a><i class="fa fa-building-o"></i> Corporate Affairs </a>
              <ul class="nav child_menu collapse collapse-apartelle collapse-student-list collapse-apartelle-registration">
          ...
          <?php if (hasAccess('curriculum/menu', $currentUser)): ?>
            <li class="nav-link-side nav-class-schedule nav-colleges nav-program nav-room nav-building nav-course nav-sections nav-block-section nav-college nav-major"><a><i class="fa fa-industry"></i> Curriculum </a>
              <ul class="nav child_menu_bot collapse collapse-class-schedule collapse-colleges collapse-program collapse-room collapse-building collapse-course collapse-sections collapse-block-section collapse-college collapse-major">
