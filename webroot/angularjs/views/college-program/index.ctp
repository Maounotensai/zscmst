...
<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">PROGRAM MANAGEMENT</h4>
            ...
            <table class="table table-bordered text-center">
              ...
              <tbody>
                <tr ng-repeat="data in datas">
                  ...
                  <td class="text-left uppercase">{{ data.program_name }}</td>
                  <!-- <td class="text-left uppercase">{{ data.acronym }}</td> -->
                  <td class="text-left uppercase">{{ data.capacity }}</td>
