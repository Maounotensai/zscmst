<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">STUDENT LOG</h4>
        <div class="clearfix"></div><hr>
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
        
                <a href="#/medical-services/student-log/student-add" class="btn btn-primary btn-sm btn-min"><i class="fa fa-plus"></i> ADD RECORD </a>
            ...
            <table class="table table-bordered text-center">
              <thead>
                <tr class="bg-info">
                  ...
                  <th style="width: 600px">PATIENT NAME</th>
                  <th>DATE</th>
                  <th>TIME</th>
                  <th>CONCERN</th>
                  <th class="w90px"></th>
              ...
              <tbody>
                <tr ng-repeat="data in datas">
                  ...
                  <td class="text-center">{{ data.concern }}</td>
                  <td>
                    <div class="btn-group btn-group-xs">
                 
                      	<a href="#/medical-services/student-log/student-view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a>
            
                      	<a href="#/medical-services/student-log/student-edit/{{ data.id }}" class="btn btn-primary" title="EDIT"><i class="fa fa-edit"></i></a>
