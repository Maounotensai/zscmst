<?php if (hasAccess('nurse profile/index', $currentUser)): ?>
<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">NURSE PROFILE MANAGEMENT</h4>
        <div class="clearfix"></div><hr>
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
              <?php if (hasAccess('nurse profile/add', $currentUser)): ?>
                <a href="#/medical-services/nurse-profile/add" class="btn btn-primary btn-sm btn-min"><i class="fa fa-plus"></i> ADD RECORD </a>
              <?php endif ?> 
              <?php if (hasAccess('nurse profile/print', $currentUser)): ?>
            ...
            <table class="table table-bordered text-center">
              <thead>
                <tr class="bg-info">
                  ...
                  <th style="width: 600px">NURSE NAME</th>
                  <th>ADDRESS</th>
                  <th>AGE</th>
                  <th>BIRTHDATE</th>
                  <th class="w90px"></th>
                  ...
                  <td>
                    <div class="btn-group btn-group-xs">
                      <?php if (hasAccess('nurse profile/view', $currentUser)): ?>
                      	<a href="#/medical-services/nurse-profile/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a>
                      <?php endif ?> 
                      <?php if (hasAccess('nurse profile/edit', $currentUser)): ?>
                      	<a href="#/medical-services/nurse-profile/edit/{{ data.id }}" class="btn btn-primary" title="EDIT"><i class="fa fa-edit"></i></a>
                      <?php endif ?> 
