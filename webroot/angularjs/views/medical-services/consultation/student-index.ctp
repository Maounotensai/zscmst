<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">CONSULTATION</h4>
          ...
          <div class="tab-content mt-3" id="myTabContent">
              ...
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                    <a href="#/medical-services/consultation/student-add" class="btn btn-primary  btn-min"><i class="fa fa-plus"></i> ADD</a>
                      ...
                      <tr ng-repeat="data in datas">
                        ...
                        <td>
                          <div class="btn-group btn-group-xs">
                            <a href="#/medical-services/consultation/student-view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a>
           
                            <a href="#/medical-services/consultation/student-edit/{{ data.id }}" class="btn btn-primary" ng-disabled="data.status != 0" title="EDIT"><i class="fa fa-edit"></i></a>
              ...
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                    ...
                    <a href="#/medical-services/consultation/student-student-add" class="btn btn-primary  btn-min"><i class="fa fa-plus"></i> ADD</a>
            ...
            <div class="tab-pane fade show " id="disapprove">
              ...
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                    <?php if (hasAccess('consultation/student-add', $currentUser)): ?>
                    <a href="#/medical-services/consultation/student-add" class="btn btn-primary  btn-min"><i class="fa fa-plus"></i> ADD</a>
                    <?php endif ?>
                    <a href="javascript:void(0)" class="btn btn-success  btn-min" ng-click="advance_search()"><i class="fa fa-search"></i> ADVANCE SEARCH</a>
                    <?php if (hasAccess('medical certificate request/print', $currentUser)): ?>
                  ...
                  <table class="table table-bordered text-center">
                    ...
                    <tbody>
                      <tr ng-repeat="data in datasDisapprove">
                        ...
                        <td>
                          <div class="btn-group btn-group-xs">
                            <?php if (hasAccess('consultation/student-view', $currentUser)): ?>
                            <a href="#/medical-services/consultation/student-view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a>
                            <?php endif ?>
                            <?php if (hasAccess('consultation/student-edit', $currentUser)): ?>
                            <a href="#/medical-services/consultation/student-edit/{{ data.id }}" class="btn btn-primary" ng-disabled="data.status != 0" title="EDIT"><i class="fa fa-edit"></i></a>
                            <?php endif ?>
                            <?php if (hasAccess('consultation/student-delete', $currentUser)): ?>
                            <a href="javascript:void(0)" ng-click="remove(data)" class="btn btn-danger" ng-disabled="data.status != 0" title="DELETE"><i class="fa fa-trash"></i></a>
                            <?php endif ?>
                          </div>
                        </td>
                  ...
                  <table class="table table-bordered text-center">
                    ...
                    <tbody>
                      <tr ng-repeat="data in datasTreated">
                        <td class="text-center">{{ (paginatorDisapprove.page - 1 ) * paginatorDisapprove.limit + $index + 1 }}</td>
                        <td class="text-center">{{ data.code }}</td>
                        <td class="text-left">{{ data.patient_name }}</td>
                        <td class="text-center">{{ data.date }}</td>
                        <td class="text-center">{{ data.age }}</td>
                  ...
                  <table class="table table-bordered text-center">
                    ...
                    <tbody>
                      <tr ng-repeat="data in datasReferred">
                        <td class="text-center">{{ (paginatorReferred.page - 1 ) * paginatorReferred.limit + $index + 1 }}</td>
                        <td class="text-center">{{ data.code }}</td>
                        <td class="text-left">{{ data.patient_name }}</td>
                        <td class="text-center">{{ data.date }}</td>
                        <td class="text-center">{{ data.age }}</td>
