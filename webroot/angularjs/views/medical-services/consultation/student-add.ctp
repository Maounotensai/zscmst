...
<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <div class="header-title">NEW CONSULTATION</div>
          ...
          <div class="row">
                ...
                <table class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-left uppercase">{{ data.Consultation.student_no }}</td>   
                    </tr>
                    <tr>
                      <th class="text-left"> STUDENT NAME </th>
                      <td class="text-left uppercase">{{ data.Consultation.student_name }}</td>   
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input number class="form-control" autocomplete="off" ng-model="data.Consultation.age" data-validation-engine="validate[required]">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
