...
<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">REFERRAL RECOMMENDATION</h4>
              ...
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                    <a href="#/medical-services/referral-recommendation/student-add" class="btn btn-primary  btn-min"><i class="fa fa-plus"></i> ADD</a>
                ...
                <table class="table table-bordered text-center">
                  ...
                  <tbody>
                    <tr ng-repeat="data in datas">
                      ...
                      <td class="text-center">{{ data.complaints }}</td>
                      <td class="text-center">{{ data.recommendations }}</td>
                      <td>
                        <div class="btn-group btn-group-xs">
                          <a href="#/medical-services/referral-recommendation/student-view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a> 
                      
                          <a href="#/medical-services/referral-recommendation/student-edit/{{ data.id }}" class="btn btn-primary" ng-disabled = "data.status != 0" title="EDIT"><i class="fa fa-edit"></i></a> 
