<?php if (hasAccess('referral_recommendation/index', $currentUser)): ?>
              ...
              <table class="table table-bordered text-center">
                ...
                <tbody>
                  <tr ng-repeat="data in datas">
                    ...
                    <td class="text-center">{{ data.nurse_name }}</td>
                    <td>
                      <div class="btn-group btn-group-xs">
                        <a href="#/medical-services/referral-recommendation/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a> 
                    
                        <a href="#/medical-services/referral-recommendation/edit/{{ data.id }}" class="btn btn-primary" ng-disabled = "data.status != 0" title="EDIT"><i class="fa fa-edit"></i></a> 
              ...
              <table class="table table-bordered text-center">
                <thread>
                  <tr class="bg-info">
                    ...
                    <th class="text-center"> PATIENT NAME </th>
                    <th class="text-center"> DATE </th>
                    <th class="text-center"> COMPAINTS </th>
                    <th class="text-center"> RECOMMENDATIONS </th>
                    <th class="w90px"></th>
                  </tr>
                </thread>
