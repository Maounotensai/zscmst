                ...
                <div class="col-md-12">
                  <div class="row">
                    <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                      <a href="#/guidance/counseling-appointment/add" class="btn btn-primary  btn-min"><i class="fa fa-plus"></i> ADD</a>
                        ...
                        <tr ng-repeat="data in datas">
                          ...
                          <td>
                            <div class="btn-group btn-group-xs">
                              <a href="#/guidance/counseling-appointment/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a> 
                              <a href="#/guidance/counseling-appointment/edit/{{ data.id }}" class="btn btn-primary" ng-disabled = "data.status != 0" title="EDIT"><i class="fa fa-edit"></i></a> 
