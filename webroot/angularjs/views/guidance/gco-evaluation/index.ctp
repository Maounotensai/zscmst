<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">GCO EVALUATION</h4>
            ...
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                  <a href="#/guidance/gco-evaluation/add" class="btn btn-primary  btn-min"><i class="fa fa-plus"></i> ADD</a>
                ...
                <table class="table table-bordered text-center">
                  <thread>
                    <tr class="bg-info">
                      ...
                      <th class="text-center"> ATTENDANCE TO COUNSELING </th>
                  ...
                  <tbody>
                    <tr ng-repeat="data in datas">
                      ...
                      <td class="text-center">{{ data.attendanceCode }}</td>
                      <td class="text-center">{{ data.date }}</td>
                      <td>
                        <div class="btn-group btn-group-xs">
                          <a href="#/guidance/gco-evaluation/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a> 
