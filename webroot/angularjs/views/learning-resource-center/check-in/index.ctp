<?php if (hasAccess('check in/index', $currentUser)): ?>
<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">CHECK IN MANAGEMENT</h4>
            ...
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                  <?php if (hasAccess('check in/add', $currentUser)): ?>
                    <a href="#/learning-resource-center/check-in/add" class="btn btn-primary  btn-min"><i class="fa fa-retweet"></i> RETURN ITEM</a>
                  <?php endif ?>
                  <a href="javascript:void(0)" class="btn btn-success  btn-min" ng-click="advance_search()"><i class="fa fa-search"></i> ADVANCE SEARCH</a>
                  <?php if (hasAccess('check in/print', $currentUser)): ?>
                    ...
                    <tr ng-repeat="data in datas">
                      ...
                      <td>
                        <div class="btn-group btn-group-xs">
                          <?php if (hasAccess('check in/view', $currentUser)): ?>
                          <a href="#/learning-resource-center/check-in/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a> 
                          <?php endif ?>
                          <?php if (hasAccess('check in/edit', $currentUser)): ?>
                          <a href="#/learning-resource-center/check-in/edit/{{ data.id }}" class="btn btn-primary" title="EDIT"><i class="fa fa-edit"></i></a> 
                          <?php endif ?>
                          <?php if (hasAccess('check in/delete', $currentUser)): ?>
