              ...
              <div class="row"> 
                <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                  <?php if (hasAccess('biblipgraphy/print barcode', $currentUser)): ?>
                    <button type="button" class="btn btn-info btn-min" ng-click="printBarcode()"><i class="fa fa-print"></i> PRINT BARCODE </button>
                  <?php endif ?>
                  <?php if (hasAccess('biblipgraphy/print call number', $currentUser)): ?>
                    <button type="button" class="btn btn-info btn-min" ng-click="printCallNumber()"><i class="fa fa-print"></i> PRINT CALL NUMBER </button>
                  <?php endif ?>
                  <?php if (hasAccess('biblipgraphy/print cataloge', $currentUser)): ?>
                    <button type="button" class="btn btn-info btn-min" ng-click="printCatalog()"><i class="fa fa-print"></i> PRINT CATALOG </button>
                  <?php endif ?>
                </div>
              </div>
          </div>
