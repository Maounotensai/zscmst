...
<div class="row">
  <div class="col-lg-12 mt-3">
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">COURSE COMPLETION FORM</h4>
          ...
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                <?php if (hasAccess('completion form/add', $currentUser)): ?>
                <a href="#/registrar/completion/add" class="btn btn-primary  btn-min"><i class="fa fa-plus"></i> ADD</a>
                <?php endif ?>
                  ...
                  <tr ng-repeat="data in datas">
                    ...
                    <td>
                      <div class="btn-group btn-group-xs">
                        ...
                        <a href="#/registrar/completion/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a>
                        <?php endif ?>
                        <?php if (hasAccess('completion form/edit', $currentUser)): ?>
                        <a href="#/registrar/completion/edit/{{ data.id }}" class="btn btn-primary" ng-disabled="data.status != 0" title="EDIT"><i class="fa fa-edit"></i></a>
                        <?php endif ?>
