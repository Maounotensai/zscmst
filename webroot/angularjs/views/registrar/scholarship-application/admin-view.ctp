            ...
            <div class="col-md-12">
              <div class="pull-right">
                ...
                <?php if (hasAccess('scholarship application/confirm', $currentUser)): ?>
                  <button href="javascript:void(0)" ng-click="confirm(data.ScholarshipApplication)" ng-disabled="data.ScholarshipApplication.approve == 2 || data.ScholarshipApplication.approve == 4" class="btn btn-success  btn-min" ><i class="fa fa-check"></i> CONFIRM </button>
                <?php endif ?>
