              ...
              <div class="row">
                <div class="col-md-8 col-xs-12" style="margin-bottom: 2px;padding-left: 0px">
                  <?php if (hasAccess('awardee management/add', $currentUser)): ?>
                    <a href="#/settings/awardee-management/add" class="btn btn-primary  btn-min"><i class="fa fa-plus"></i> ADD</a>
                  <?php endif ?>
                  <a href="javascript:void(0)" class="btn btn-success  btn-min" ng-click="advance_search()"><i class="fa fa-search"></i> ADVANCE SEARCH</a>
                  <?php if (hasAccess('awardee management/print', $currentUser)): ?>
                    ...
                    <tr ng-repeat="data in datas">
                      ...
                      <td>
                        <div class="btn-group btn-group-xs">
                          ...
                          <a href="#/settings/awardee-management/view/{{ data.id }}" class="btn btn-success" title="VIEW"><i class="fa fa-eye"></i></a> 
                          <?php endif ?>
                          <?php if (hasAccess('awardee management/edit', $currentUser)): ?>
                          <a href="#/settings/awardee-management/edit/{{ data.id }}" class="btn btn-primary" ng-disabled = "data.status != 0" title="EDIT"><i class="fa fa-edit"></i></a> 
                          <?php endif ?>
