                        ...
                        <tr ng-repeat="data in datas">
                          ...
                          <td>
                            <div class="btn-group btn-group-xs">
                              ...
                              <?php endif ?>
                              <?php if (hasAccess('cat/edit', $currentUser)): ?>
                              <a href="#/admission/student-application/edit/{{ data.id }}" class="btn btn-primary" ng-disabled = "data.status != 0" title="EDIT"><i class="fa fa-edit"></i></a> 
                              <?php endif ?>
